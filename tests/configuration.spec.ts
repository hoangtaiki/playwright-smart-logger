...
test.describe('Browser Console Capture Option', () => {
  ...
  test('should capture browser console when enabled', async ({ page, smartLog }) => {
  ...
  test('should not capture when disabled (default)', async ({ page, smartLog }) => {
    ...
    await page.goto('data:text/html,<script>console.log("should not be captured")</script>');
