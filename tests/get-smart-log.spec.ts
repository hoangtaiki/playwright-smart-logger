...
test.describe('SmartLog - Global Accessors', () => {
  test.describe('getSmartLog Function', () => {
    test('should return current fixture inside test', async ({
      smartLog: fixture,
    }) => {
  ...
  test.describe('smartLog Proxy', () => {
    test('should log directly without function call', async ({
      smartLog: fixture,
    }) => {
    ...
    test('should work from page object model', async ({
      smartLog: fixture,
    }) => {
    ...
    test('should have all methods available', async ({
      smartLog: _fixture,
    }) => {
      const methods = [
        'log',
      ...
      methods.forEach(method => {
        expect(typeof smartLog[method as keyof typeof smartLog]).toBe(
          'function'
        );
      });
    });
  ...
  test.describe('Interoperability', () => {
    test('proxy and function share same buffer', async ({
      smartLog: fixture,
    }) => {
    ...
    test('methods should maintain proper binding', async ({
      smartLog: _fixture,
    }) => {
